        ...
        return {
            ...
            link: function linkFn($scope, $elem, $attrs) {
                ...
                function stickElement(closestLine) {
                    ...
                    //alert('elemheig:' + $elem.height() + '- wind heig: ' + window.innerHeight + '-ofset : ' + offset);
                    /*if ($elem.height() > window.innerHeight - offset) {
                        var mxh =  window.innerHeight - offset - 20;
                        $elem.css('max-height',mxh+'px')
                        .css('overflow', 'scroll')
